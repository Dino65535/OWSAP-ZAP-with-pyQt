...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Alert_Summary_Label.setGeometry(QtCore.QRect(610, 150, 171, 41))
        font = QtGui.QFont()
        ...
        self.High_Alert_Label.setGeometry(QtCore.QRect(610, 200, 41, 41))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(20)
        font.setBold(False)
        ...
        self.Medium_Alert_label.setGeometry(QtCore.QRect(610, 240, 71, 41))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(20)
        ...
        self.Low_Alert_Label.setGeometry(QtCore.QRect(610, 280, 41, 41))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(20)
        ...
        self.Info_Alert_Label.setGeometry(QtCore.QRect(610, 320, 111, 41))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(20)
        ...
        self.High_Alert_Number.setGeometry(QtCore.QRect(740, 200, 51, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.Medium_Alert_Number.setGeometry(QtCore.QRect(740, 240, 51, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.Info_Alert_Number.setGeometry(QtCore.QRect(740, 320, 51, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.Low_Alert_Number.setGeometry(QtCore.QRect(740, 280, 51, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.Delete_All_Alert_Button.setGeometry(QtCore.QRect(700, 370, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.Report_Alert_Button.setGeometry(QtCore.QRect(610, 370, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.show.setGeometry(QtCore.QRect(10, 50, 591, 351))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.show.setFont(font)
        self.show.setObjectName("show")
        self.line = QtWidgets.QFrame(self.centralwidget)
        self.line.setGeometry(QtCore.QRect(610, 110, 171, 61))
